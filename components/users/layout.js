      ...
      <div className="socialMedia">
        <ul>
          <li className="whatsapp">
            <Link href="whatsapp://send?abid=&text=Merhaba, yakın zamanda evleniyoruz. 🎉 Sizi de aramızda görmek isteriz. Davetiyemizi online olarak ulaşmak için : http://davetiyem.co/damatgelin adresine gidebilirsiniz. Bekliyoruz 	😊">
              <a target="_blank">
          ...
          <li className="sms">
            <Link href="sms:?body=Merhaba, yakın zamanda evleniyoruz. 🎉 Sizi de aramızda görmek isteriz. Davetiyemizi online olarak ulaşmak için : http://davetiyem.co/damatgelin adresine gidebilirsiniz. Bekliyoruz 	😊">
              <a target="_blank">
          ...
          <li className="facebook">
            <Link href="http://www.facebook.com/sharer/sharer.php?u=http://davetiyem.co/damatgelin">
              <a target="_blank">
          ...
          <li className="mail">
            <Link href="mailto:?subject=Evleniyoruz, Düğünümüze Davetleisiniz?&body=Merhaba, yakın zamanda evleniyoruz. 🎉 Sizi de aramızda görmek isteriz. Davetiyemizi online olarak ulaşmak için : http://davetiyem.co/ dddd adresine gidebilirsiniz. Bekliyoruz 	😊">
              <a target="_blank">
